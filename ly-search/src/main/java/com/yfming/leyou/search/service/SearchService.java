package com.yfming.leyou.search.service;

import com.yfming.leyou.common.entity.PageResult;
import com.yfming.leyou.search.controller.SearchRequest;
...
public class SearchService {
    ...
    public PageResult<Goods> search(SearchRequest request) {
        ...
        // 封装结果并返回
        return new PageResult<Goods>(pageInfo.getTotalElements(), new Long(pageInfo.getTotalPages()), pageInfo.getContent());
    }
}